...
if __name__ == '__main__':
    ...
    db = QueryDB("bolt://localhost:7687", "neo4j", "12345678")
    res0 = db.query("queries/desembarque_total_departamento.cypher")
    res1 = db.query("queries/desembarque_total_especie.cypher")
    res2 = db.query("queries/mayor_consumo_especie.cypher")
    res3 = db.query("queries/producciones_departamento.cypher")
    mostrar(res0)
    mostrar(res1)
    mostrar(res2)
    mostrar(res3)
